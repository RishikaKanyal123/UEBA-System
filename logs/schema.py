...
IF_MODELS_PKL    = os.path.join(MODELS_DIR, "isolation_forest_models.pkl")
SCALERS_PKL      = os.path.join(MODELS_DIR, "scalers.pkl")
ML_PREDICTIONS_CSV = os.path.join(PROCESSED_DIR, "ml_predictions.csv")
SCENARIO_CLF_PKL = os.path.join(MODELS_DIR, "scenario_clf.pkl")